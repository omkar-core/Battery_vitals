...
import { bhiStatus, safetyColor, safetyLabel, formatNumber } from '../src/lib/utils'
import styles from '../src/styles/dashboard.module.css'

const CIRC = 2 * Math.PI * 88

export default function Dashboard() {
  const { data, history, connected, mode, sendControl } = useRealTimeData()
    ...
    return (
      <Layout connected={false}>
        <div className={styles.loading}>
          ...
          <p>Connecting to data stream{data ? '' : ' (waiting for ESP32)...'}</p>
        </div>
      </Layout>
    )
  }
      ...
      <div className={styles.hero}>
        ...
        <div className={styles.heroCards}>
          <div className={styles.metricsGrid}>
            ...
            <MetricCard title="Temp" value={formatNumber(temperature, 1)} unit="°C" color="#FF2D55" />
