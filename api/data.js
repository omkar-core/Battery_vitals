...
// POST /api/data - ESP32 uploads live sensor readings (primary endpoint)
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      console.error('[data] DB connect failed:', dbErr.message);
    ...
    const opMap = { CHARGING: 'CHARGING', DISCHARGING: 'DISCHARGING', IDLE: 'IDLE' };
    const op = opMap[(d.op || '').toUpperCase()] || 'IDLE';
    ...
    await LiveData.findOneAndUpdate({ batteryId }, {
      ...
      safety, bhi: d.bhi, opDirection: op, resistance: d.resistance,
