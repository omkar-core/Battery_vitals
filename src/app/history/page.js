          ...
          <div style={{ position: 'relative', paddingLeft: '24px', borderLeft: '2px solid var(--border)' }}>
            {events.map((evt, idx) => (
              ...
              >
                ...
                <p style={{ margin: '8px 0 12px 0', fontSize: '14px', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
                  {evt.description}
                </p>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <h3 style={{ margin: 0, fontSize: '16px', color: 'var(--text-primary)' }}>AI Event Analysis</h3>
              <button onClick={() => setSelectedEvent(null)} style={{ background: 'none', border: 'none', color: 'var(--text-muted)', fontSize: '18px', cursor: 'pointer' }}>✕</button>
            </div>
            ...
            {explaining ? (
              ...
              <div style={{ backgroundColor: 'var(--bg-surface-raised)', border: '1px solid var(--border)', padding: '14px', borderRadius: '8px', fontSize: '14px', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
                {explanation}
              </div>
            )}
          </div>
